	...
	<body style="overflow:hidden">
		...
		<div class="container-fluid content">	
			<div class="row">
				...
				<div class="sidebar">
					<div class="sidebar-collapse">
						...
						<div class="sidebar-header">
							<img src="../../assets/img/logo1.png" height="65" class="img-responsive" alt="" />
						</div>
						<!-- Sidebar Menu-->
				...
				<!-- Main Page -->
				<div class="main" style="margin: 0px;padding-top: 95px;padding-bottom: 0px">
					<!-- Page Header -->
					...
					<div class="row">
						...
						<div id="myCarousel" class="carousel slide">
							...
							<div class="carousel-inner">
								...
								<img src="../../assets/img/slide_1.jpg" style="width:100%;" alt="First slide">
								</div>
								<div class="item">
								<img src="../../assets/img/slide_2.jpg" style="width:100%;" alt="Second slide">
								</div>
								<div class="item">
								<img src="../../assets/img/slide_3.jpg" style="width:100%;" alt="Third slide">
								</div> 
							</div>
							<!-- 轮播（Carousel）导航 -->
